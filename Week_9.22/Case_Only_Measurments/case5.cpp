...
{
  // use threshold 11.5
  int verticalMeasurements[10] = {0, 0, 10, 10, 2, 2, 2, 2, 0, 0};
  int horizontalMeasurements[10] = {2, 2, 2, 2, 2, 2, 2, 2, 6, 6};
  int diagonalMeasurements[19] = {0, 0, 1, 2, 3, 4, 4, 4, 3, 2, 2, 2, 1, 0, 0, 0, 0, 0, 0};
  int antiDiagonalMeasurements[19] = {0, 0, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 0, 0};
  // Reconstruction
  int row, col;
  ...
  {
    for (col = 0; col < n; col++)
      if (reconstruction[row][col] > 11.5)
  ...
  Display image02(grayImage, "output5");
